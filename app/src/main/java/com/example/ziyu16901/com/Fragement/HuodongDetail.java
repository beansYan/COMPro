...
import com.example.ziyu16901.com.Bean.HdDetail;
import com.example.ziyu16901.com.R;

public class HuodongDetail extends Fragment {
    public static final String ITEM_ID = "item_id";
    // 保存该Fragment显示的Book对象
    HdDetail.HDdetail detail;
    @Override
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        {
            detail = HdDetail.ITEM_MAP.get(getArguments()
                    .getInt(ITEM_ID)); // ①
        }
    }
            ...
            , ViewGroup container, Bundle savedInstanceState)
    {
        ...
        View rootView = inflater.inflate(R.layout.fragment_huodong_detail,
                container, false);
        if (detail != null)
        {
