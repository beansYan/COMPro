...
public class NoteActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SqliteDBConnect sd = new SqliteDBConnect(NoteActivity.this);
        ...
        btnCommit.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Builder adb = new Builder(NoteActivity.this);
                adb.setTitle("保存");
                ...
                adb.setNegativeButton("取消",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,
                                                int which) {
                                Toast.makeText(NoteActivity.this, "不保存！",
        ...
        etName.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if ("".equals(etName.getText().toString().trim())) {
                    etName.setText(R.string.note_prompt1);
                }
            }
        });
        etMain.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                // TODO Auto-generated method stub
        ...
        etMain.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if ("".equals(etMain.getText().toString().trim())) {
                    etMain.setText(R.string.note_prompt2);
                }
            }
        });
    }
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            adb.setNegativeButton("不保存", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    intent2.setClass(NoteActivity.this, MainShow.class);
    ...
    public int testTime() {
        try {
            ...
            if (mi < 0 || mi > 60)
                flag = 1;
            if (flag == 1) {
                Toast.makeText(NoteActivity.this, "时间格式不正确，请单击或长按时间框设置",
                        Toast.LENGTH_SHORT).show();
                return 0;
            }

        } catch (Exception e) {
            Toast.makeText(NoteActivity.this, "日期时间不正确，请单击或长按时间框设置",
                    Toast.LENGTH_SHORT).show();
            return 0;
        }
        return 1;
